  ...
  return(
    <div className="space-y-2">
        ...
        <FormField control={control} name="restaurantName" render={({field})=>(
            ...
            <FormControl>
                <Input {...field} className="bg-white outline-none "/>
            </FormControl>
            <FormMessage/>
          </FormItem>)}
        />
        ...
        <FormField control={control} name="deliveryPrice" render={({field})=>(
            ...
            <FormControl>
                <Input {...field} className="bg-white outline-none  " placeholder="1.50"/>
            </FormControl>
            <FormMessage/>
          </FormItem>)}
        />
        <FormField control={control} name="estimatedDeliveryTime" render={({field})=>(
            ...
            <FormControl>
                <Input {...field} className="bg-white outline-none  " placeholder="30"/>
            </FormControl>
            <FormMessage/>
          </FormItem>)}
        />
