...
const UsernameMenu = () => {
  ...
  return(
    <DropdownMenu>
        <DropdownMenuTrigger className="flex items-center px-3 font-bold text-orange-500 hover:text-orange-800 outline-none gap-2">
        <CircleUserRound className="text-orange-500 w-8" />
            {user?.email }
